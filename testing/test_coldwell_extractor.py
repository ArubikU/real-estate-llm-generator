#!/usr/bin/env python
"""
Test script for Coldwell Banker extractor.
"""
...
def test_coldwell_extraction():
    """Test Coldwell Banker extractor with real URL."""
    
    url = "https://www.coldwellbankercostarica.com/property/land-for-sale-in-curridabat/2897"
    
    print("=" * 80)
    print("🧪 TESTING COLDWELL BANKER EXTRACTOR")
    print("=" * 80)
    print(f"\n📍 URL: {url}\n")
    ...
    print(f"\n🔧 Step 2: Getting extractor for coldwellbankercostarica.com...")
    try:
    ...
    # Save to JSON
    output_file = 'test_coldwell_output.json'
    try:
